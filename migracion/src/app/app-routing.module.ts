...
import { AuthCanActivateFn, AuthService, AuthWithRedirectCanActivate, InRoleCanActivate, InRoleCanActivateFn, LoginFormComponent, RegisterUserComponent } from './security';
...
const routes: Routes = [
  ...
  { path: 'libros', loadChildren: () => import('./libros/modulo.module'), canActivate: [ AuthWithRedirectCanActivate('/login'), InRoleCanActivate('Empleados')] },
